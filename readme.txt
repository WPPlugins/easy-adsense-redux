...
*Easy AdSense Redux* Same as *Easy AdSense* but with Ad Space sharing code removed
...
Option to suppress in-line style statements so that you can use your style.css to control the ad blocks. 
Updating a few translations (`tr_TR`, `de_DE`).
...
* Turkish: [Omer Faruk](http://ramerta.com "Easy AdSense in Turkish (Turkce Ceviri)"), [Nurullah DEMIR](http://www.nurullah.us "Nurullah DEMIR").
* Spanish: [Joaquin R. Rizer](http://www.shanky.com.ar "Joaquin R. Rizer"), [Maikel Frias](http://www.maikeladas.es "Maikel Frias"), [Argelio D&Atilde;&shy;az](http://www.goymad.com "El Ca&Atilde;&plusmn;izo"), [MaLk Gopher](http://malk-gopher.com/blog "MaLk Gopher & Friends"), [Pablog Pabloixx](http://rockstarunder.com.ar "RockStar Under")
...
* Italian: [Angelo D Agostino](http://www.console-war.com "Angelo D Agostino"), [NokiaSymbian](http://www.nokiasymbian.it/wp "NokiaSymbian"), Saverio Tonno.
...
* Chinese: `zh_CN`: [Akii Snow](http://www.akii.org "Akii Snow"), [ShenMeng](http://shenmeng.org "ShenMeng"). `zh_TW`: [AKiRA](http://akr.tw/ "AKiRA").
